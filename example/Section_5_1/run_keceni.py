...
def run_task(task_id):
    ...
    ## distance in G
    _ = G.get_dist()
    ste_bbb_dr = inf.ste_bbb_sdw(phis_dr, G, hops, n_bst=n_bst)
    ste_hac_dr = inf.ste_hac_sdw(phis_dr, G, inf.box_kernel, bw=hops)
    
    sdd_bbb_dr = inf.ste_bbb_sdw(phis_dr[...,1] - phis_dr[...,0], G, hops, n_bst=n_bst)
    sdd_hac_dr = inf.ste_hac_sdw(phis_dr[...,1] - phis_dr[...,0], G, inf.box_kernel, bw=hops)
